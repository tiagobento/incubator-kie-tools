...
import { WebApp, DevWebAppProps } from "./DevWebApp.stories";
        ...
        <dmn:invocation id="_EB658586-C3C8-488E-8118-E69E31583106">
          ...
          <dmn:binding>
            ...
            <dmn:literalExpression id="_51ACEC3C-4207-4F5F-8FDD-9EDAA3270E60">
              <dmn:text
              >(Requested Product.Amount * ((Requested Product.Rate/100)/12)) / (1-(1/(1+(Requested Product.Rate/100)/12) * -Requested Product.Term))</dmn:text>
            </dmn:literalExpression>
          </dmn:binding>
          <dmn:binding>
