...
Create and edit Dashbuilder, Serverless Workflow, BPMN, DMN and Test Scenario files.
...
- Create and edit Test Scenario (\*.scesim) files with the Test Scenario Editor.
