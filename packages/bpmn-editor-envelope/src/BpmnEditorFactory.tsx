...
import { BpmnEditorRoot } from "./BpmnEditorRoot";

export class BpmnEditorFactory implements EditorFactory<Editor, KogitoEditorEnvelopeApi, KogitoEditorChannelApi> {
  public createEditor(
...
export class BpmnEditorInterface implements Editor {
