...
```bash
# From repo root:
npm exec --prefix ci -- bun ci/src/cli.ts --help

npm exec --prefix ci -- bun ci/src/cli.ts setup-patterns --outputPath=/tmp/ci-patterns.json

npm exec --prefix ci -- bun ci/src/cli.ts build-mode \
  --forceFull=false \
...
npm exec --prefix ci -- bun ci/src/cli.ts summary \
...
npm exec --prefix ci -- bun ci/src/cli.ts check-junit-reports --patternsJsonPath=/tmp/ci-patterns.json
```
